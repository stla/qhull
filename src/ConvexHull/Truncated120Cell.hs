...
vertices6 coords =
  ...
  where perms = filter isEvenPermutation (P.permutations 4)
...
-- The coordinates of the truncated 120-cell, centered on the origin and having edge length 2, are all P.permutations of coordinate
-- and changes of sign of:
--
-- (1, 3+4*phi, 3+4*phi, 3+4*phi)
-- (phi*phi*phi, phi*phi*phi, phi*phi*phi, 5+6*phi)
-- (2*phi*phi, 2*phi*phi, 2*phi*phi, 2*phi4)
-- as well as even P.permutations of coordinate and all changes of sign of:
--
